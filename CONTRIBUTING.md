...
Before reporting an issue on the [issue tracker](https://github.com/TerakomariGandesblood/server/issues),
...
```shell
git clone https://github.com/TerakomariGandesblood/server
cd cli
cargo test
```
